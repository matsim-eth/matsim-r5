...
public class CrowflyDistanceEstimator implements DistanceEstimator {
	...
	public CrowflyDistanceEstimator(LatLonToCoordTransformation latLonToCoord, double beelineDistanceFactor) {
	...
	public double getDistance(Stop fromStop, Stop toStop, int routeIndex) {
		...
		return CoordUtils.calcEuclideanDistance(fromCoord, toCoord) * beelineDistanceFactor;
	}
}
